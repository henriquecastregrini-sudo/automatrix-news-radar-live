(function () {
  const update = {
    stamp: '29 AGO 2026 · 08:01 BRT',
    sensor: 'GitHub API ao vivo + agents-radar 2026-08-28 como sensor auxiliar + busca pública',
    top: [
      {
        rank: 1,
        title: 'Archify',
        ...
        facts: '29.124 stars · 1.823 forks · JavaScript · push em 28 AGO · +1.903 stars versus leitura anterior do radar',
      ...
      },
      {
        ...
        facts: '37.225 stars · 3.532 forks · Python · push em 28 AGO · +696 stars versus leitura anterior do radar',
      ...
      },
      {
        ...
        facts: 'thedotmack/claude-mem: 92.539 stars · 8.137 forks · push em 29 AGO',
      ...
      },
      {
        ...
        facts: '76.450 stars · 6.537 forks · Python · push em 25 AGO · updated em 29 AGO',
      ...
      },
      {
        ...
        facts: '53.632 stars · 6.674 forks · Python · último push em 22 AGO · atividade pública em 29 AGO',
    ...
    monitored: [
      {
        ...
        facts: '76.450 stars · 6.537 forks · 105 issues · último push 25 AGO',
        action: 'Usar como comparação quando a pauta envolver agente navegando web/social.'
      },
      {
        repo: 'TencentCloud/TencentDB-Agent-Memory',
        status: 'Ativo no radar',
        facts: '25.100 stars · 2.332 forks · 740 issues · último push 27 AGO',
      ...
      },
      {
        ...
        facts: '1.022 stars · 190 forks · último push 29 AGO · digest local ainda em 28 AGO',
