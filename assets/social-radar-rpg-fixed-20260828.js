(function () {
  ...
  function profileLinks(profileName, data) {
    ...
    return [
      ['Canal', data.channel],
      ['Vídeos recentes', search('https://www.youtube.com/results?search_query=', baseQuery)],
      ['Notícias', search('https://www.google.com/search?tbm=nws&q=', baseQuery)],
      ['X/Twitter', search('https://x.com/search?q=', baseQuery)],
      ['TikTok', search('https://www.tiktok.com/search?q=', baseQuery)],
      ['GitHub', search('https://github.com/search?q=', data.niche)]
    ];
  }
